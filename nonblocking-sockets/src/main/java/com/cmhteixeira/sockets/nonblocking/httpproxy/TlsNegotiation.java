...
public class TlsNegotiation {
  ...
  public void run() throws IOException {
    ...
    recursive(sslEngineResult.getHandshakeStatus(), sslEngineResult.getStatus());
  }

  private void recursive(HandshakeStatus handshakeStatus, Status status) throws IOException {
  ...
  private void read() throws IOException {
    ...
    int bytesRead = socketChannel.read(writeEncryptedBuffer.flip());
    System.out.printf("After reading %d: %s\n===\n", bytesRead, writeEncryptedBuffer);
  }
}
